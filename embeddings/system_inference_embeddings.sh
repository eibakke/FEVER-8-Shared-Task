...
SYSTEM_NAME="embeddings"  # Change this to "HerO", "Baseline", etc.
SPLIT="dev_nano"             # Change this to "dev", or "test"
BASE_DIR="."            # Current directory
NUM_EXAMPLES=1          # Default: use full dataset (0 = full dataset)
...
while [[ $# -gt 0 ]]; do
  case $1 in
    ...
    *)
      ...
      echo "Usage: /system_inference_embeddings.sh [--num-examples=N] [--system=NAME] [--split=SPLIT] [--base-dir=DIR] [--resume-step=STEP]"
      exit 1
      ;;
  esac
done
